...
/*   Updated: 2021/01/10 21:50:27 by lle-briq         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			fill_int_right_p(char **to_print, char *nb, t_print par,
				int size);
void			fill_int_right(char **to_print, char *nb, int size);
void			fill_int_left_p(char **to_print, char *nb, t_print par,
				int size);
